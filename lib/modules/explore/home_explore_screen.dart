              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (index == 0) {
                    return TitleView(
                      titleTxt:
                          LocalLanguage(context).of("popular_destination"),
                      subTxt: '',
                      animation: animation,
                      animationController: widget.animationController,
                      click: () {},
                    ...
                    return TitleView(
                      titleTxt: LocalLanguage(context).of("best_deal"),
                      subTxt: LocalLanguage(context).of("view_all"),
                      animation: animation,
                      isLeftButton: true,
                      animationController: widget.animationController,
                      click: () {
                ...
                child: Opacity(
                  ...
                  child: CommonButton(
                    ...
                    buttonTextWidget: Padding(
                      ...
                      child: Text(
                        LocalLanguage(context).of("view_hotel"),
      ...
      child: CommonCard(
        ...
        child: InkWell(
          ...
          child: CommonSearchBar(
            ...
            enabled: false,
            text: LocalLanguage(context).of("where_are_you_going"),
          ),
        ),
      ),
    );
