            ...
            child: Column(
              ...
              children: <Widget>[
                CommonAppbarView(
                  ...
                  titleText: LocalLanguage(context).of("setting_text"),
                ),
                Expanded(
                  ...
                  child: _getSelectedUI(
                    e == ThemeModeType.system
                        ...
                        : e == ThemeModeType.light
                            ? FontAwesomeIcons.cloudSun
                            : FontAwesomeIcons.cloudMoon,
                    LocalLanguage(context).of(e.toString().split(".")[1]),
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      LocalLanguage(context).of("Hello"),
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.all(16),
                          child: Text(
                            LocalLanguage(context).of("selected_fonts"),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Text(
                      LocalLanguage(context).of("Selected color"),
                      style: TextStyles(context)
                          .getBoldStyle()
                          .copyWith(fontSize: 22),
                    ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      LocalLanguage(context).of("Selected language"),
                      style: TextStyles(context)
                          .getBoldStyle()
                          .copyWith(fontSize: 22),
                    ),
